...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("~/.config/scripts/wallpaper_changer")
end)
...
--Power Keys for restart & shutdown
hl.bind(mainMod .. " + KP_SUBTRACT", hl.dsp.exec_cmd("poweroff"))
hl.bind(mainMod .. " + ALT + KP_SUBTRACT", hl.dsp.exec_cmd("reboot"))
-- Move focus with mainMod + arrow keys
hl.bind(mainMod .. " + left", hl.dsp.focus({ direction = "left" }))
hl.bind(mainMod .. " + right", hl.dsp.focus({ direction = "right" }))
hl.bind(mainMod .. " + up", hl.dsp.focus({ direction = "up" }))
hl.bind(mainMod .. " + down", hl.dsp.focus({ direction = "down" }))
hl.bind("KP_SUBTRACT", hl.dsp.exec_cmd("alacritty"))
...
hl.bind(mainMod .. "+ m" ,hl.dsp.exec_cmd(control_center))
...
--ScreenShot  keys requires hyprshot
...
-- Override Noctalia with Catppuccin Mocha (matching Waybar)
hl.config({
  general = {
    col = {
      active_border   = "0x66777777",
